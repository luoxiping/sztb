package com.sztb.socialsecurity.widget.xlist;
...
public class XScrollListView extends ListView implements OnScrollListener {
	private float mLastY = -1; // save event y
	private Scroller mScroller; // used for scroll back
	private OnScrollListener mScrollListener; // user's scroll listener

	// the interface to trigger refresh and load more.
	private IXSListViewListener mListViewListener;
...
//		setSelection(mTotalItemCount - 1); // scroll to bottom
	...
	public void setXListViewListener(IXSListViewListener l) {
		mListViewListener = l;
	}
	 ...
	 */
	public interface IXSListViewListener {
